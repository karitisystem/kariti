          ...
          <div class="inner_container">
            <?php
             ...
             <div class="span_input_search">
               ...
               <img class="search_svg" src="images/Icons/pesquisar.svg">
             </label>
            </div>
            <?php
              ...
              echo '<tbody>';
                ...
                echo '<td>';
              	echo '<a href="editStudent.php?id_student='.$rows[$i]['id_aluno'].'"><img src="images/Icons/editar.svg" height=20> </a>';
                echo '</td>';

                echo '<td>';
            		echo '<a onclick="return confirm(\'Deseja realmente apagar '.$rows[$i]["nome_aluno"].'?\');" href="deleteStudent.php?id_student='.$rows[$i]['id_aluno'].'"><img src="images/Icons/excluir.svg" height=20> </a>';
                echo '</td>';
