    ...
    <script>
      function changeArrow(id){
        ...
        if(arrow.src.indexOf('arrow_up') != -1){
          ...
          arrow.src = 'images/Icons/arrow_up.svg';
          input.value = parseInt(input.value) + 1;
          setTimeout(function(){
            arrow.src = 'images/Icons/arrow_up_c.svg';
          },150);
        }else if(arrow.src.indexOf('arrow_down') != -1){
          let input = document.getElementById('input_number_'+id.replace('arrow_down_',''))
          arrow.src = 'images/Icons/arrow_down.svg';
          if(parseInt(input.value) > 1){
            input.value = parseInt(input.value) - 1;
          }
          setTimeout(function(){
            arrow.src = 'images/Icons/arrow_down_c.svg';
          },150);
        }
      }
    </script>
        ...
        <form action="addTemplate.php" method="post">
          <div class="title">CADASTRO DE PROVA</div>
            <div class="inner_container">
              ...
              <span class="arrows">
                <img id="arrow_up_1" onclick="changeArrow('arrow_up_1')" class="arrow_svg" src="images/Icons/arrow_up_c.svg">
                <img id="arrow_down_1" onclick="changeArrow('arrow_down_1')" class="arrow_svg" src="images/Icons/arrow_down_c.svg">
              </span>
              </span>
            </span>
            ...
            <span class="span_input_number_text">
              ...
              <span class="arrows">
                <img id="arrow_up_2" onclick="changeArrow('arrow_up_2')" class="arrow_svg" src="images/Icons/arrow_up_c.svg">
                <img id="arrow_down_2" onclick="changeArrow('arrow_down_2')" class="arrow_svg" src="images/Icons/arrow_down_c.svg">
              </span>
              </span>
              </span>
            </div>
