  ...
  <body>
      ...
      <section class="window">
        <div class="container all">
          <form action="setEditUser.php?id_user=<?php echo $id_user_edit; ?>" method="post">
          ...
          <a href='javascript:history.back(-1)'><img src="images/Icons/voltar.svg" class="icon_voltar"></a>
