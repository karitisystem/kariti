      ...
      <div class="container all">
        ...
        <div class="inner_container">
          ...
          <?php
            ...
            echo '<td>';
          	echo '<a href="editClass.php?id_class='.$rows[$i]['id_turma'].'"><img src="images/Icons/editar.svg" height=20></a>';
            echo '</td>';

            echo '<td>';
        		echo '<a onclick="return confirm(\'Deseja realmente apagar '. $rows[$i]["nome_turma"].'?\');" href="deleteClass.php?id_class='.$rows[$i]['id_turma'].'"><img src="images/Icons/excluir.svg" height=20></a>';
            echo '</td>';
